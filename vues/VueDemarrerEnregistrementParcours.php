			...
			<div data-role="content">
				...
				<form action="index.php?action=DemarrerEnregistrementParcours" method="post" data-ajax="false">
					...
					<div data-role="fieldcontain" class="ui-hide-label">
						...
						<label for="txtAutorisationAutreUtilisateurs">Souhaitez-vous envoyer un mail automatique aux utilisateurs autorisés pour suivre votre parcours ?</label>
						<input type="checkbox" name="btnAutorisationAutreUtilisateurs" id="txtAutorisationAutreUtilisateurs">
					</div>
